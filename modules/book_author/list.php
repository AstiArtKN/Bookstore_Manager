...
if(isGet()){
    ...
    if(!empty($search__user)){
        ...
        $chuoiWhere .= " (tenTacGia LIKE '%$search__user%') ";
    }
}


//xử lý trang
$maxData = getRows("SELECT ID FROM tacgiasach");
...
if( !empty($search__user)){
    $maxData2 = getRows("SELECT ID FROM tacgiasach 
     $chuoiWhere");
...
<div class="book-editor">
    <div class="book-editor__header">
        <h2 class="dashboard__mid-title">Danh Sách tác giả</h2>
        <?php 
        ...
        ?>
        <a href="?module=book_author&action=add" class="book-editor__add btn"><i class="fa-solid fa-plus"></i> Thêm </a>
    </div>
    <div class="book-editor__tool">
        <form method="GET" action="">
            <input type="hidden" name="module" value="book_author">
        ...
        <table class="dashboard__table dashboard__table-mid book-editor_table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td class="tensach"><?php echo $item['tenTacGia']; ?></td>

                    <td>
                        <a href="?module=book_author&action=edit&id=<?php echo $item['ID'];?>" class="btn btn-warning">
                            <i class="fa-solid fa-pencil"></i>
                        </a>
                    </td>
                    <td>
                        <a href="?module=book_author&action=delete&id=<?php echo $item['ID'];?>" class="btn btn-danger"
