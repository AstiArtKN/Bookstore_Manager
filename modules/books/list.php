...
if(isGet()){
    ...
    if(!empty($search__user)){
        ...
        $chuoiWhere .= " (sach.tenSach LIKE '%$search__user%') ";
    }
    ...
    if(!empty($slt_quyenhan)){
        if(strpos($chuoiWhere, 'WHERE') == false){
         ...
         $chuoiWhere .= " sach.theLoaiId = '$slt_quyenhan' ";
    }
}
...
// echo $chuoiWhere;
$getDetailUser = getAll("SELECT sach.ISBN, sach.tenSach, tacgiasach.tenTacGia, theloaisach.tenTheLoai,
nhaxuatban.tenNhaXuatBan, sach.gia, sach.soLuong, sach.hinhAnh, sach.soTrang
FROM sach
        ...
        <form method="GET" action="">
            ...
            <div class="book-editor__tool-form">
                <div class="show-entries">
                    <label for="slt_quyenhan">Thể loại: </label>
        ...
        <table class="dashboard__table dashboard__table-mid book-editor_table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $item['tenNhaXuatBan']; ?></td>
