...
if(isPost()){
    ...
    $maID = $filter['ID'];
    $checkID = getRows("SELECT * FROM theloaisach WHERE ID = '$maID' ");
    ...
    if(empty($errors)){
        ...
        $insertStatus = insert('theloaisach', $dataInsert);
        if($insertStatus){
            setSessionFlash('msg', 'thêm thể loại thành công!!!');
            setSessionFlash('msg_type', 'success');
        }else{
             setSessionFlash('msg', 'Thêm thể loại thất bại.');
